...
typedef GHashTable * (* wrap_key_stm_func) (GHashTable *key_attrs, keyagent_buffer_ptr iv);
...
DECLARE_STM_INTERFACE(create_challenge, keyagent_buffer_ptr, ());
DECLARE_STM_INTERFACE(set_session, gboolean, (keyagent_buffer_ptr));
DECLARE_STM_INTERFACE(load_key, gboolean, (keyagent_keytype type, keyagent_key_attributes_ptr));
DECLARE_STM_INTERFACE(challenge_generate_request, const gchar *, ());
DECLARE_STM_INTERFACE(challenge_verify, keyagent_buffer_ptr, (keyagent_buffer_ptr quote));
DECLARE_STM_INTERFACE(wrap_key, keyagent_key_attributes_ptr, (keyagent_keytype type, keyagent_key_attributes_ptr attrs));
...
#define LOOKUP_STM_INTERFACES(MODULE,ERROR) do {\
    ...
    INIT_STM_INTERFACE(MODULE,wrap_key,ERROR); \
